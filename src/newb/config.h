...
#define NL_NIGHT_MOONLIGHT_COL vec3(0.008,0.030,0.050)
...
#define NL_DAY_ZENITH_COL    vec3(0.075,0.55,1.50)
#define NL_DAY_HORIZON_COL   vec3(0.18,0.80,1.50)
#define NL_DAY_EDGE_COL      vec3(0.525,1.05,1.50)
...
#define NL_NIGHT_ZENITH_COL   vec3(0.006,0.022,0.035)
#define NL_NIGHT_HORIZON_COL  vec3(0.018,0.055,0.070)
#define NL_NIGHT_EDGE_COL     vec3(0.028,0.070,0.085)
