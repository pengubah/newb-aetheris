...
/* Color correction */
#define NL_TONEMAP_TYPE 3              // 1:Exponential, 2:Reinhard, 3:Extended Reinhard, 4:ACES, 5:ACES Filmic
...
#define NL_NIGHT_MOONLIGHT_COL vec3(0.001,0.001,0.001)
...
#define NL_NIGHT_ZENITH_COL   vec3(0.003,0.006,0.020)
#define NL_NIGHT_HORIZON_COL  vec3(0.008,0.022,0.050)
#define NL_NIGHT_EDGE_COL     vec3(0.012,0.035,0.070)
