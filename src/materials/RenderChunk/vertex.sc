...
void main() {
  ...
  fogColor.a = nlRenderFogFade(relativeDist, FogColor.rgb, FogAndDistanceControl.xy);
    ...
    fogColor.a=mix(fogColor.a,1.0,min(NL_GODRAY*nlRenderGodRayIntensity(cPos,worldPos,t,uv1,relativeDist,FogColor.rgb,env.dayFactor,env.sunDir,viewDir),1.0));
  #endif
