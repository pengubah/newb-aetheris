...
void main() {
  vec4 color = v_color0;
    ...
    cloudPos.xz += CameraPosition.xz;
      ...
      #ifdef NL_AURORA
        color += renderAurora(cloudPos, v_color2.a, v_color1.a, vec3(v_dayFactor))*(1.0-0.95*color.a);
      #endif
      ...
      #ifdef NL_AURORA
        p.xy *= 34.7;
        color += renderAurora(p.xyy, v_color2.w, v_color1.w, vec3(v_dayFactor))*(1.0-0.95*color.a);
      #endif
